...
FLOW=${1:-compile}
case "$FLOW" in
    map) CMD="quartus_map --read_settings_files=on projects/punchout_pocket.qpf -c punchout_pocket" ;;
    compile) CMD="quartus_sh --flow compile projects/punchout_pocket.qpf" ;;
